...
const About = () => {
  ...
  const skills = ['JavaScript (ES6+)', 'React', 'Node.js', 'Java', 'Swift', 'xCode'];
    ...
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        <StyledText>
          <div>
            <p>
              Hello! I'm Gowtham Potnuru, a tech enthusiast and software developer with a foundation
              in Computer Science from Northeastern University. My passion for technology began with
              exploring programming languages and frameworks, leading me to dive into the
              complexities of systems and applications.
            </p>
